...
const HUEL_LOGO = "data:image/png;base64,";
      ...
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-white text-center">
          <div className="mb-6 flex flex-col items-center">
            <img src={HUEL_LOGO} alt="Huel" className="h-16 w-auto mb-2" />
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full">
        <div className="text-center mb-8">
          <div className="mb-2 flex flex-col items-center">
            <img src={HUEL_LOGO} alt="Huel" className="h-12 w-auto mb-1" style={{ filter: 'invert(1)' }} />
      ...
      <div className="bg-white rounded-lg shadow-xl p-8 max-w-2xl w-full">
        <div className="mb-8">
          <div className="flex justify-between items-center mb-4">
            <div className="flex items-center gap-2">
              <img src={HUEL_LOGO} alt="Huel" className="h-7 w-auto" style={{ filter: 'invert(1)' }} />
              <span className="text-xl font-black" style={{ color: '#FFCB00' }}>Fit</span>
              <span className="text-xl font-semibold text-gray-500 ml-1">— Get Started</span>
            </div>
    ...
    <>
      ...
      <div className="bg-black text-white p-4 shadow-lg">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <img src={HUEL_LOGO} alt="Huel" className="h-8 w-auto" />
            <span className="text-2xl font-black tracking-tight" style={{ color: '#FFCB00' }}>Fit</span>
          </div>
